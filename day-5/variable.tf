...
variable "single_nat_gateway" {
  description = "If true, deploy a single NAT Gateway shared by all private subnets (cheaper, less resilient). If false, deploy one NAT Gateway per AZ (recommended for production)."
  type        = bool
  default     = true
}
